...
```{r}
#code used for sample subset of files
library(readr)
library(plyr)
library(R.utils)
library(base)
...
unzip_files(manifestname = "sample_gdc_manifest.txt", directorylocation = "../Final Project/Sample HTSeq GDC Data/")
...
sample_patient_data <- create_main_data(manifestname = "sample_gdc_manifest.txt", directorylocation = "../Final Project/Sample HTSeq GDC Data/", firstfile = sample_first_file)
sample_clinical_data <- create_clinical_data(fileLocation = "../Final Project/gdc_download_20180223_145229.tar.gz")
